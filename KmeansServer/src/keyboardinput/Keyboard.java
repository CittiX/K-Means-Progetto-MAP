...
public class Keyboard {
	...
	public static String readString() {
		...
		try {
			...
			error("Error reading String src.data, null value returned.");
			str = null;
		}
		return str;
	}
	...
	public static boolean readBoolean() {
		...
		try {
			if (token.toLowerCase().equals("true"))
				...
				error("Error reading boolean src.data, false value returned.");
				bool = false;
			}
		} catch (Exception exception) {
			error("Error reading boolean src.data, false value returned.");
	...
	public static char readChar() {
		...
		try {
			...
			error("Error reading char src.data, MIN_VALUE value returned.");
	...
	public static int readInt() {
		...
		try {
			...
			error("Error reading int src.data, MIN_VALUE value returned.");
	...
	public static long readLong() {
		...
		try {
			...
			error("Error reading long src.data, MIN_VALUE value returned.");
	...
	public static float readFloat() {
		...
		try {
			...
			error("Error reading float src.data, NaN value returned.");
			value = Float.NaN;
		}
		return value;
	}
	...
	public static double readDouble() {
		...
		try {
			...
			error("Error reading double src.data, NaN value returned.");
			value = Double.NaN;
		}
		return value;
	}
